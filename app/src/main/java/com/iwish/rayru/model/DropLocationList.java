...
public class DropLocationList {
    ...
    public DropLocationList(String description, String id, String matched_substrings, String place_id, String reference, String structured_formatting, String terms) {
